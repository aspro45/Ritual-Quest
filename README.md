...
The production reviewer, campaign manager, and event manager allowlists use the same four Ritual roles: Event Manager (`1349043996114161704`), Radiant Ritualist (`1430908117331218442`), Ritualist (`1339006464139984906`), and Mods (`1218322564573822986`). The signed session preserves the complete role-ID snapshot returned by Discord. The passport displays only IDs explicitly listed in the frontend role map, so unconfigured server roles never receive guessed labels or appear as raw IDs.
